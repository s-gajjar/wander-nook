    ...
    (async () => {
      try {
        ...
        if (mounted && !data?.isAdmin) {
          const next = encodeURIComponent("/admin/article/new");
      ...
      <form onSubmit={onSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="mt-1 text-xs text-gray-500">
            This will be used in the URL: /article/<span className="font-mono">{slug || 'your-slug'}</span>
          </div>
        </div>
        ...
        >
          {loading ? "Publishing..." : coverUploading ? "Wait for uploads..." : "Publish Article"}
        </button>
      </form>
    </main>
  );
